...
const getSliceId=(sliceName,sliceProps)=>{if(!Object.keys(sliceProps).length){return sliceName;}const propsString=createContentDigest(sliceProps);return`${sliceName}-${propsString}`;};const ServerSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesProps=(0,external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_.useContext)(context.SlicesPropsContext);const concreteSliceName=slicesMap[sliceName];if(!concreteSliceName){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}const sliceId=getSliceId(concreteSliceName,sliceProps);// set props on context object for static-entry to return
let sliceUsage=slicesProps[sliceId];if(!sliceUsage){slicesProps[sliceId]=sliceUsage={props:sliceProps,sliceName:concreteSliceName,hasChildren:!!children};}else{if(children){sliceUsage.hasChildren=true;}}return/*#__PURE__*/external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().createElement(server_slice_renderer.ServerSliceRenderer,{sliceId:sliceId},children);};
;// ./.cache/slice/inline-slice.js
const InlineSlice=({sliceName,allowEmpty,children,...sliceProps})=>{const slicesMap=(0,external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_.useContext)(context.SlicesMapContext);const slicesResultsMap=(0,external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_.useContext)(context.SlicesResultsContext);const concreteSliceName=slicesMap[sliceName];const slice=slicesResultsMap.get(concreteSliceName);if(!slice){if(allowEmpty){return null;}else{throw new Error(`Slice "${concreteSliceName}" for "${sliceName}" slot not found`);}}return/*#__PURE__*/external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().createElement(slice.component,Object.assign({sliceContext:slice.sliceContext,data:slice.data},sliceProps),children);};
;// ./.cache/slice.js
"use client";function Slice(props){if(true){// we use sliceName internally, so remap alias to sliceName
const internalProps={...props,sliceName:props.alias};delete internalProps.alias;delete internalProps.__renderedByLocation;const slicesContext=(0,external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_.useContext)(context.SlicesContext);// validate props
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return/*#__PURE__*/external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().createElement(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return/*#__PURE__*/external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return/*#__PURE__*/external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().createElement(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
const fullStack=external_C_Users_$RareWaffle_OneDrive_Desktop_one_love_grooming_node_modules_react_index_js_default().__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDebugCurrentFrame.getCurrentStack();// remove the first line of the stack trace
...
var _react = _interopRequireDefault(__webpack_require__(2594));
...
const React=__webpack_require__(2594);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(9166);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
module.exports = require("C:\\Users\\$RareWaffle\\OneDrive\\Desktop\\one-love-grooming\\node_modules\\react\\index.js");
...
"use strict";
module.exports = require("C:\\Users\\$RareWaffle\\OneDrive\\Desktop\\one-love-grooming\\.cache\\ssr-builtin-trackers\\fs");
...
var React = _interopRequireWildcard(__webpack_require__(2594));
...
var _react = __webpack_require__(2594);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(2594),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-about-js":()=>__webpack_require__.e(/* import() | component---src-pages-about-js */ 432).then(__webpack_require__.bind(__webpack_require__, 9434)),"component---src-pages-contact-js":()=>__webpack_require__.e(/* import() | component---src-pages-contact-js */ 209).then(__webpack_require__.bind(__webpack_require__, 5351)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 293).then(__webpack_require__.bind(__webpack_require__, 9168)),"component---src-pages-quote-js":()=>__webpack_require__.e(/* import() | component---src-pages-quote-js */ 657).then(__webpack_require__.bind(__webpack_require__, 2863)),"component---src-pages-services-js":()=>__webpack_require__.e(/* import() | component---src-pages-services-js */ 371).then(__webpack_require__.bind(__webpack_require__, 4355))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-google-fonts',plugin:__webpack_require__(2901),options:{"plugins":[],"fonts":["Inter:400,700","Playfair Display:400,700"],"display":"swap"}},{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/******/ 			return "" + {"125":"component---src-pages-404-js","209":"component---src-pages-contact-js","293":"component---src-pages-index-js","371":"component---src-pages-services-js","432":"component---src-pages-about-js","657":"component---src-pages-quote-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
